...
static const vl53l0x_info_t g_vl53l0x_infos[] =
{
		[VL53L0X_IDX_FIRST] = { .addr = 0x30 },
#if VL53L0X_SECOND
		[VL53L0X_IDX_SECOND] = { .addr = 0x31 },
#endif
};
...
bool vl53l0x_is_ranging_complete(vl53l0x_idx_t idx)
{
	...
	if ((interrupt_status & 0x07) == VL53L0X_REG_SYSTEM_INTERRUPT_GPIO_NEW_SAMPLE_READY)
		return 1;
	else
		return 0;
